...
class FormmoduleController extends Controller {
    ...
    public $form_view = 'backend.modules.formmodule';
    public $form_export = 'backend.modules.formmodule-table';
    ...
    public function default() {
        ...
        $this->data = ModuleConfig::form_modules();
    ...
    public function getExistData($id) {
        ...
        $table = $module->module_tables()->where("formmodule_id", $id)->get();
        $input = $module->module_inputs()->where("formmodule_id", $id)->get();
